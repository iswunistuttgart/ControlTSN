...
#ifndef NAMESPACE_TSNDEP_GENERATED_H_
#define NAMESPACE_TSNDEP_GENERATED_H_
...
extern UA_StatusCode namespace_tsndep_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_TSNDEP_GENERATED_H_ */
