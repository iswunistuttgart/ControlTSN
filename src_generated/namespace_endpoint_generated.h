...
#ifndef NAMESPACE_ENDPOINT_GENERATED_H_
#define NAMESPACE_ENDPOINT_GENERATED_H_
...
extern UA_StatusCode namespace_endpoint_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_ENDPOINT_GENERATED_H_ */
