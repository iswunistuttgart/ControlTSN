...
#ifndef NAMESPACE_PCMSUBSCRIBER_GENERATED_H_
#define NAMESPACE_PCMSUBSCRIBER_GENERATED_H_
...
extern UA_StatusCode namespace_pcmsubscriber_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_PCMSUBSCRIBER_GENERATED_H_ */
